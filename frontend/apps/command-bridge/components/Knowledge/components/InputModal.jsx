...
export const InputModal = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="relative w-full max-w-xl bg-[#151518] border border-yellow-500/30 rounded-lg shadow-[0_0_50px_rgba(234,179,8,0.2)] overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    ...
                    <div className="relative group">
                        <input
                            ...
                            className="w-full bg-[#0d0d0e] border border-white/10 text-white px-4 py-4 rounded focus:outline-none focus:border-yellow-500 transition-colors text-lg font-mono placeholder:text-zinc-600"
                        />
