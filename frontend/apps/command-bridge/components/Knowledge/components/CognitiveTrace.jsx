...
export const CognitiveTrace = ({ filterBrain, externalLog }) => {
    ...
    return (
        <div className="absolute bottom-0 left-0 right-0 h-48 bg-[#111113]/95 border-t border-zinc-800 z-30 flex flex-col backdrop-blur-md shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
