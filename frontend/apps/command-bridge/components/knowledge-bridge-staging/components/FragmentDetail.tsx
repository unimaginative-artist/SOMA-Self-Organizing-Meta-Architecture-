...
import { Fragment, BrainType } from '../types';
...
interface FragmentDetailProps {
  ...
  onClose: () => void;
  onAction: (action: 'anchor' | 'trace' | 'fork' | 'promote' | 'erase', fragment: Fragment) => void;
  isTraced: boolean;
}

export const FragmentDetail: React.FC<FragmentDetailProps> = ({ fragment, onClose, onAction, isTraced }) => {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] z-50 animate-in zoom-in-95 duration-200">
       <div 
         className="bg-slate-900/95 backdrop-blur-xl border rounded-lg shadow-2xl overflow-visible"
